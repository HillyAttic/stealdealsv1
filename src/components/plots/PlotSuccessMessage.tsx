...
interface PlotSuccessMessageProps {
  isOpen: boolean;
  onClose: () => void;
  onDownload: () => void;
  plotName: string;
...
export function PlotSuccessMessage({ isOpen, onClose, onDownload, plotName, autoClose = true }: PlotSuccessMessageProps) {
      ...
      >
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            Thank you for your interest in <span className="font-semibold" style={{ color: '#154D71' }}>{plotName}</span>. 
