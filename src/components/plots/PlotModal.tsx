        ...
        <div className="p-6">
          ...
          <div className="hidden lg:block mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
                  <span className="px-3 py-1 rounded-full text-sm mr-3 bg-orange-600 text-white">🔒</span>
                  Downloads
                </h3>
                <div className="relative p-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 h-[280px] flex flex-col bg-gradient-to-r from-orange-500 to-red-600">
                  <div className="absolute top-0 right-0 w-20 h-20 rounded-full opacity-20 -mt-10 -mr-10 bg-orange-400"></div>
                  <div className="absolute bottom-0 left-0 w-16 h-16 rounded-full opacity-20 -mb-8 -ml-8 bg-red-700"></div>
                  <div className="relative z-10 flex-1 flex flex-col">
                    <div className="flex items-start justify-between mb-3">
                      <div className="bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1">
                        <span className="text-white text-xs font-medium uppercase tracking-wider">UNLOCK REQUIRED</span>
                      </div>
                      <div className="px-3 py-1 rounded-full text-xs font-bold animate-pulse bg-yellow-400 text-red-800">LOCKED!</div>
                    </div>
                    <div className="flex-1 flex flex-col justify-center">
                      <p className="text-white font-bold text-lg leading-relaxed mb-4">Submit your details to unlock exclusive investor discovery kit</p>
                    ...
                    <div className="mt-auto pt-3 border-t border-white/30">
                      <p className="text-white/90 text-sm font-medium mb-3">
                        <strong>Get Access::</strong> Fill the form to unlock premium investment materials
                      </p>
                      <button
                        onClick={handleInvestorKitClick}
                        className="w-full flex justify-center items-center py-3 px-6 rounded-lg font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-75 disabled:cursor-not-allowed disabled:transform-none bg-white text-orange-600 hover:bg-orange-50"
                      >
          ...
          <div className="lg:hidden mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="mb-6">
              ...
              <div className="relative p-6 rounded-xl mb-6 shadow-lg transform hover:scale-105 transition-all duration-300 bg-gradient-to-r from-orange-500 to-red-600">
                <div className="absolute top-0 right-0 w-16 h-16 rounded-full opacity-20 -mt-8 -mr-8 bg-orange-400"></div>
                <div className="absolute bottom-0 left-0 w-12 h-12 rounded-full opacity-20 -mb-6 -ml-6 bg-red-700"></div>
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-3">
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1">
                      <span className="text-white text-xs font-medium uppercase tracking-wider">UNLOCK</span>
                    </div>
                    <div className="px-2 py-1 rounded-full text-xs font-bold animate-pulse bg-yellow-400 text-red-800">LOCKED!</div>
                  </div>
                  <p className="text-white font-bold text-base leading-relaxed mb-2">Submit details to unlock kit</p>
                  ...
                  <div className="mt-4">
                    <button
                      onClick={handleInvestorKitClick}
                      className="w-full flex justify-center items-center py-3 px-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-75 disabled:cursor-not-allowed disabled:transform-none bg-white text-orange-600 hover:bg-orange-50"
                    >
