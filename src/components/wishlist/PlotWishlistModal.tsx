          ...
          <div className="p-6">
              ...
              <div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="prose prose-blue max-w-none text-gray-700">
                    <p>{property.description || 'Premium plot in prime location'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:block mt-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
                    <span className="px-3 py-1 rounded-full text-sm mr-3 bg-orange-600 text-white">
                      {isUnlocked ? '🔓' : '🔒'}
                    </span>
                    Downloads
                  </h3>
                  <div className="relative p-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 h-[280px] flex flex-col bg-gradient-to-r from-orange-500 to-red-600">
                    <div className="relative z-10 flex-1 flex flex-col">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="px-3 py-1 rounded-full text-xs font-bold animate-pulse bg-yellow-400 text-red-800">
                      ...
                      <div className="mt-auto pt-3 border-t border-white/30">
                        ...
                        <button
                          ...
                          className="w-full flex justify-center items-center py-3 px-6 rounded-lg font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 bg-white text-orange-600 hover:bg-orange-50"
                        >
      ...
      {showGatedModal && (
        <div className="fixed inset-0 flex items-center justify-center z-[60] p-4 bg-black/50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="mb-4">Contact us at info@stealdeals.co.in or call +91 96 3040 3080</p>
